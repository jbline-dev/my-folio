...
export const projects: Project[] = [
  {
    ...
    summary:
      "A spatial data platform for visualizing large geographic datasets in the browser.",
    description: [
    ...
    outcome:
      "Adopted by three research teams; reduced dataset exploration time from hours to minutes.",
    status: "Shipped",
  },
  {
    slug: "signal",
    ...
    outcome:
      "Powers live collaboration for an internal tooling suite used daily by 400+ engineers.",
    status: "Shipped",
  },
  {
    slug: "grain",
    ...
    summary:
      "A minimalist note system that treats writing as a spatial canvas.",
    description: [
  ...
  },
  {
    ...
    outcome:
      "Featured in two productivity roundups; retired to focus on newer work.",
    status: "Archived",
  },
];
...
export const experiments: Experiment[] = [
  {
    title: "Flow Fields",
    blurb: "Vector-field particle systems rendered on the GPU.",
    tag: "WebGL",
  },
  {
    title: "Type Weather",
    blurb: "Variable fonts that respond to live weather data.",
    tag: "Canvas",
  },
  {
    title: "Latency Map",
    blurb: "Real-time visualization of global network round-trips.",
    tag: "D3",
  },
  {
    title: "Sketch DB",
    blurb: "A query language you draw instead of type.",
    tag: "Research",
  },
  {
    title: "Ambient CLI",
    blurb: "A terminal that reacts to the time of day.",
    tag: "Rust",
  },
  {
    title: "Paper Radio",
    blurb: "Generative ambient audio from text input.",
    tag: "Web Audio",
  },
];
...
export const experience: ExperienceItem[] = [
  {
    ...
    role: "IT Intern",
    detail:
      "Developed a four web-based information systems, including a 911 Emergency System, ICT Inventory System, Network-Attached Storage (NAS) System, and Directory System, supporting office operation and information managements",
  },
  {
    period: "2024 — 2025",
    ...
    detail:
      "Developed a knowledge-based troubleshooting and appointment management system using PHP, MySQL, HTML, CSS, and JavaScript.",
  },
];
...
export const stack: { group: string; items: string[] }[] = [
  ...
  {
    group: "Frontend",
    items: ["React", "Next.js", "Tailwind", "WebGL", "Canvas"],
  },
  {
    group: "Backend",
    items: ["Node", "PostgreSQL", "Redis", "gRPC", "GraphQL"],
  },
...
export const logs: LogEntry[] = [
  {
    time: "2026-09-21",
    hash: "a3f9c1e",
    message: "refactor: streamline canvas render loop",
  },
  {
    time: "2026-09-18",
    hash: "7b2d0aa",
    message: "feat: add reduced-motion background fallback",
  },
  {
    time: "2026-09-14",
    hash: "e91c4d2",
    message: "docs: rewrite project case studies",
  },
  {
    time: "2026-09-09",
    hash: "1cc78ff",
    message: "feat: ship terminal command palette",
  },
  {
    time: "2026-09-02",
    hash: "44ab903",
    message: "perf: batch strokes into single path",
  },
  {
    time: "2026-08-27",
    hash: "9de1207",
    message: "chore: migrate to typed design tokens",
  },
];

export const about: string[] = [
  "I’m an aspiring software engineer focused on the space where interface, systems and craft overlap. I like building tools that feel calm to use and honest about what they do underneath.",
